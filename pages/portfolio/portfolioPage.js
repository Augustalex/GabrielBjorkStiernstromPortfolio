...
module.exports = function () {
    ...
    function Project(project, rootRelativePath) {
        
        let thumbnailSrc = `${rootRelativePath}/file/img/thumbnail/${project.name}.png`
    ...
    function QuickImage(dir, image, hasLowResVersion = true) {
        let name = image.name
        let fileExtension = image.fileExtension || '.png'
        let imageElement = document.createElement('img')
        
        let lowResPath = `${dir}/${name}_low${fileExtension}`
        let highResPath = `${dir}/${name}_high${fileExtension}`

/***
 *      MULTIPLE FILES HERE, THIS IS THE ORDER:
 *          3rd Party
 *       - Hammer.js
 *       - Hammer-time.js
 *
...
!function (a, b, c, d) {
    ...
    ia.prototype = {
        set: function (a) {
            return la(this.options, a), a.touchAction && this.touchAction.update(), a.inputTarget && (this.input.destroy(), this.input.target = a.inputTarget, this.input.start()), this
        }, stop: function (a) {
...
!function () {
    ...
    if (!c && b && a) {
        ...
        var d = /touch-action[:][\s]*(none)[^;'"]*/, e = /touch-action[:][\s]*(manipulation)[^;'"]*/,
            f = /touch-action/, g = navigator.userAgent.match(/(iPad|iPhone|iPod)/g) ? !0 : !1, h = function () {
                try {
        ...
        window.Hammer.time = {
            getTouchAction: function (a) {
                ...
                var b = a.target.getBoundingClientRect(), c = b.top !== this.pos.top || b.left !== this.pos.left,
...
function loadContent(fileSource) {
    return new Promise((resolve, reject) => {
        ...
        xhr.onreadystatechange = function () {
            if (this.status !== 200) {
                reject("Could not load " + window.coolshowUtils.relativePath + fileSource);
            }
            else {
...
function loadScript(subPageSource) {
    ...
    return new Promise((resolve, reject) => {
        if (!window.coolshowUtils) {
            reject("Relative path not set, cannot load script " + subPageSource);
        }
        else {
...
const DynamicImage = require('./DynamicImage.js')
const DynamicImageLoader = require('./DynamicImageLoader.js')()